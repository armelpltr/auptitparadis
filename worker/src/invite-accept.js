...
export async function handleInviteAccept(request, env, cors) {
  ...
  // Pas de jeton renvoyé : le navigateur se connecte avec l'adresse et le
  // mot de passe qu'il vient de choisir. Se connecter reste permis même
  // quand l'inscription publique est fermée.
